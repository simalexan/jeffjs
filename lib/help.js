...
function showHelp() {
  return console.log(`
	...
	AVAILABLE OPTIONS:
	 ...
	 ${colors.magenta('gen')}           ${colors.cyan('or')} ${colors.magenta('generate')}  Generates a serverless project, needs an additional parameter when executing command ${colors.cyan('| default: false')}
