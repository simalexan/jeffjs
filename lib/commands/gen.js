  ...
  const source = (options && options.source) || process.cwd(),
    ...
    generateProject = function (projectPath) {
      ...
      return prepareFolder
        ...
        .then(() => commandUtil.genRoute('../app-templates/dynamo/api-create.js', endpoints[0], projectPath))
        .then(() => commandUtil.genRoute('../app-templates/dynamo/api-read.js', endpoints[0], projectPath))
        .then(() => commandUtil.genRoute('../app-templates/dynamo/api-update.js', endpoints[0], projectPath))
        .then(() => commandUtil.genRoute('../app-templates/dynamo/api-delete.js', endpoints[0], projectPath))
        .then(() => {
